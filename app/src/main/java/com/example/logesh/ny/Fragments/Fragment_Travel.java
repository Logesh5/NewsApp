 ...
 */
public class Fragment_Travel extends Fragment implements ItemTouchListener, TravelLoadedListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.layout_travel, container, false);

        rvTravel = (RecyclerView) v.findViewById(R.id.recyclerViewTravel);
        ...
        new TaskLoadTravel(this).execute();
    ...
    public void onItemTouch(int position) {
        Toast.makeText(getActivity(), "Travel" + position, Toast.LENGTH_SHORT).show();
    }

    @Override
    public void onTravelLoad(ArrayList<NewsItem> travelList) {
        this.list = travelList;
        adapter.setArrayList(travelList);
    }
}
