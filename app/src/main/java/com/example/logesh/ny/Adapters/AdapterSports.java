 ...
 */
public class AdapterSports extends RecyclerView.Adapter<AdapterSports.MySportsHolder> {
    ...
    public AdapterSports(Context context, ItemTouchListener itemTouchListener){
    ...
    @Override
    public MySportsHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View v = inflater.inflate(R.layout.item_top_layout,parent,false);
        MySportsHolder holder = new MySportsHolder(v,itemTouchListener);
        return holder;
    }

    @Override
    public void onBindViewHolder(final MySportsHolder holder, int position) {
        ...
        if(imgURL != null && imgURL.length()>2){
            imageLoader.get(imgURL, new ImageLoader.ImageListener() {
                ...
                public void onResponse(ImageLoader.ImageContainer response, boolean isImmediate) {
                    Log.d("logsi", "inside image setter sports");
    ...
    public static class MySportsHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ImageView ivPic;
        TextView tvHeader;
        TextView tvSection;
        ItemTouchListener itemListener;

        public MySportsHolder(View itemView,ItemTouchListener itemListener) {
            super(itemView);
